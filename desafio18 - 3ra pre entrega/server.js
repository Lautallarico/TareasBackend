...
app.listen(config.SERVER.PORT, () => {
    logger.info(`Server inicializado en el puerto ${config.SERVER.PORT} - Desafio 18 - Tercer pre-entrega`)
    console.log(`Server inicializado en el puerto ${config.SERVER.PORT} - Desafio 18 - Tercer pre-entrega`)
}).on('error', error => {
